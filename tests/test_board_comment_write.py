...
def test_guest_comment_write_input(client):
...
def test_logined_comment_write_input(client_user):
...
def test_guest_comment_write(client):
...
def test_logined_comment_write(client_user):
